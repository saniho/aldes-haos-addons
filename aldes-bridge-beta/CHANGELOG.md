...
## [0.13.5-beta2] — 2026-09-08

### Ajouté
- **Backend** : persistance séparée des données santé (PreH, Text, RVeI, MfAc...) dans `telemetry.json` sous la clé `"health"` — garantit l'affichage du panneau santé au redémarrage
